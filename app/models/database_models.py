from sqlalchemy import Column, Integer, String, Float, DateTime, ForeignKey, Text, Boolean, JSON, LargeBinary
...
class Model(Base):
    ...
    model_type = Column(String(50))  # e.g., 'RandomForest', 'SVM', 'LogisticRegression'
    model_file_path = Column(String(255))  # Path to joblib file
    model_binary = Column(LargeBinary)  # Joblib binary stored in DB
    training_date = Column(DateTime, default=datetime.utcnow)
    status = Column(String(20), default="untrained")  # untrained, training, trained, failed
